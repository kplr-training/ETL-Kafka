...
##### Reminder to Instructor : Optional objective : InterBroker Exchange Test
...
Set the following fields in the next window :
 - set the IP address
 - replace ec2-user by your technical user name (both in the arborescence and the "user name" field")
 - do NOT check key file
 - specify the provided password 
